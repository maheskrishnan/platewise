...
- Comparison queue pins up to six selections in the library view; the dedicated comparison page renders the detailed table (macros, fats, carbs, fiber, cholesterol, vitamins, minerals) with a toggle for per-100 g, per-100-calorie, per-454 g (1 lb), and per-1-kg normalization.
